...
# this script downloads all srtm90 zipped tiles
# fixes some zip archives with bad filenames inside
# and generates virtual raster layer

download_list=static_data/srtm90m_urls.csv
srtm_zip_dir=data/in/srtm90m
srtm_vrt_dir=data/mid/srtm90m

mkdir -p $srtm_zip_dir
mkdir -p $srtm_vrt_dir

# takes about 2 hours to download, errors while downloading will be logged into _download-errors.log
# 14295 files, 15G
