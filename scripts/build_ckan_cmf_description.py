...
def ckan_cmf_description(filename):
    ...
    print('         "url":"https://mekillot-backet.website.yandexcloud.net/cmfs/'+geoextent+'_cmf_json.zip",')
    print('         "format": "GeoJson"')
    print('        },')
    print('        {"name":"'+short_geoextent+' Crash Move Folder as ESRI shape",')
    print('         "url":"https://mekillot-backet.website.yandexcloud.net/cmfs/'+geoextent+'_cmf_shp.zip",')
