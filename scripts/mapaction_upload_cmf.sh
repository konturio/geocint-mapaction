...
# FIX: CKAN_DATA_URL url from env
aws s3 cp "data/out/cmf/$country_code.shp.zip" $CKAN_DATA_URL$country_code.shp.zip --acl public-read
aws s3 cp "data/out/cmf/$country_code.geojson.zip" $CKAN_DATA_URL$country_code.geojson.zip --acl public-read
